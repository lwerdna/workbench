...
_quote, _if, _set, _define, _lambda, _begin, _definemacro, = [Sym(x) for x in
"quote   if   set!  define   lambda   begin   define-macro".split()]

_quasiquote, _unquote, _unquotesplicing = [Sym(x) for x in
...
def let(*args):
    ...
    return [[_lambda, list(vars)] + [expand(x) for x in body]] + [expand(x) for x in vals]
