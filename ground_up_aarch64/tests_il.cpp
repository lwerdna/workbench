...
void add(void)
{
	loc_0:
	// sp = sp - 0x10
	SET_REG8("sp", SUB8(REG("sp"), 0x10));
	// [sp + 0xc {var_4}].d = w0
	STORE4(ADD8(REG("sp"), 12), REG("w0"));
	// [sp + 8 {var_8}].d = w1
	STORE4(ADD8(REG("sp"), 8), REG("w1"));
	// w8 = [sp + 0xc {var_4}].d
	SET_REG4("w8", LOAD4(ADD8(REG("sp"), 12)));
	// w9 = [sp + 8 {var_8}].d
	SET_REG4("w9", LOAD4(ADD8(REG("sp"), 8)));
	// w0 = w8 + w9
	SET_REG4("w0", ADD4(REG("w8"), REG("w9")));
	// sp = sp + 0x10
	SET_REG8("sp", ADD8(REG("sp"), 0x10));
	// <return> jump(x30)
	RET(REG("x30"));
	return;
}
...
void test_byte_e_10(void)
{
	...
	SET_REG8("sp", SUB8(REG("sp"), 0x10));
	// [sp + 0xb {var_5}].b = w0.b
	STORE1(ADD8(REG("sp"), 11), LOW_PART1(REG("w0")));
	// w8 = zx.d([sp + 0xb {var_5}].b)
	SET_REG4("w8", ZX4(LOAD1(ADD8(REG("sp"), 11))));
	...
	loc_8:
	// if (w8 & 0x1 != 0) then 9 @ 0x4c else 12 @ 0x40
	if(CMP_NE(AND(REG("w8"), 1), 0))
		goto loc_9;
	else
		goto loc_12;
	...
	loc_15:
	// w0 = [sp + 0xc {var_4}].d
	SET_REG4("w0", LOAD4(ADD8(REG("sp"), 12)));
	// sp = sp + 0x10
	SET_REG8("sp", ADD8(REG("sp"), 0x10));
	// <return> jump(x30)
	RET(REG("x30"));
...
void test_byte_ne_10(void)
{
	...
	loc_8:
	// if (w8 & 0x1 != 0) then 9 @ 0x84 else 12 @ 0x78
	if(CMP_NE(AND(REG("w8"), 1), 0))
		goto loc_9;
	else
		goto loc_12;
...
void test_byte_slt_10(void)
{
	...
	SET_REG4("w8", SX1(LOAD1(ADD8(REG("sp"), 11))));
	// if (w8 s>= 0xa) then 4 else 6
	if(CMP_SGE4(REG("w8"), 10))
		goto loc_4;
	else
		goto loc_6;
	...
	loc_8:
	// if (w8 & 0x1 != 0) then 9 @ 0xbc else 12 @ 0xb0
	if(CMP_NE(AND(REG("w8"), 1), 0))
		goto loc_9;
	else
		goto loc_12;
...
void test_byte_ult_10(void)
{
	...
	loc_8:
	// if (w8 & 0x1 != 0) then 9 @ 0xf4 else 12 @ 0xe8
	if(CMP_NE(AND(REG("w8"), 1), 0))
		goto loc_9;
	else
		goto loc_12;
...
void test_byte_sle_10(void)
{
	...
	loc_8:
	// if (w8 & 0x1 != 0) then 9 @ 0x12c else 12 @ 0x120
	if(CMP_NE(AND(REG("w8"), 1), 0))
		goto loc_9;
	else
		goto loc_12;
...
void test_byte_ule_10(void)
{
	...
	loc_8:
	// if (w8 & 0x1 != 0) then 9 @ 0x164 else 12 @ 0x158
	if(CMP_NE(AND(REG("w8"), 1), 0))
		goto loc_9;
	else
		goto loc_12;
...
void test_byte_sge_10(void)
{
	...
	loc_8:
	// if (w8 & 0x1 != 0) then 9 @ 0x19c else 12 @ 0x190
	if(CMP_NE(AND(REG("w8"), 1), 0))
		goto loc_9;
	else
		goto loc_12;
...
void test_byte_uge_10(void)
{
	...
	loc_8:
	// if (w8 & 0x1 != 0) then 9 @ 0x1d4 else 12 @ 0x1c8
	if(CMP_NE(AND(REG("w8"), 1), 0))
		goto loc_9;
	else
		goto loc_12;
...
void test_byte_sgt_10(void)
{
	...
	loc_8:
	// if (w8 & 0x1 != 0) then 9 @ 0x20c else 12 @ 0x200
	if(CMP_NE(AND(REG("w8"), 1), 0))
		goto loc_9;
	else
		goto loc_12;
...
void test_byte_ugt_10(void)
{
	...
	loc_8:
	// if (w8 & 0x1 != 0) then 9 @ 0x244 else 12 @ 0x238
	if(CMP_NE(AND(REG("w8"), 1), 0))
		goto loc_9;
	else
		goto loc_12;
...
void test_byte_neg(void)
{
	...
	loc_8:
	// if (w8 & 0x1 != 0) then 9 @ 0x27c else 12 @ 0x270
	if(CMP_NE(AND(REG("w8"), 1), 0))
		goto loc_9;
	else
		goto loc_12;
...
void test_byte_pos(void)
{
	...
	loc_8:
	// if (w8 & 0x1 != 0) then 9 @ 0x2b4 else 12 @ 0x2a8
	if(CMP_NE(AND(REG("w8"), 1), 0))
		goto loc_9;
	else
		goto loc_12;
...
void test_word_e_10(void)
{
	...
	SET_REG8("sp", SUB8(REG("sp"), 0x10));
	// [sp + 0xa {var_6}].w = w0.w
	STORE2(ADD8(REG("sp"), 10), LOW_PART2(REG("w0")));
	// w8 = zx.d([sp + 0xa {var_6}].w)
	SET_REG4("w8", ZX4(LOAD2(ADD8(REG("sp"), 10))));
	// if (w8 != 0xa) then 4 else 6
	if(CMP_NE(REG("w8"), 10))
		goto loc_4;
	else
	...
	loc_8:
	// if (w8 & 0x1 != 0) then 9 @ 0x2ec else 12 @ 0x2e0
	if(CMP_NE(AND(REG("w8"), 1), 0))
		goto loc_9;
	else
		goto loc_12;
...
void test_word_ne_10(void)
{
	...
	loc_8:
	// if (w8 & 0x1 != 0) then 9 @ 0x324 else 12 @ 0x318
	if(CMP_NE(AND(REG("w8"), 1), 0))
		goto loc_9;
	else
		goto loc_12;
...
void test_word_slt_10(void)
{
	...
	SET_REG4("w8", SX2(LOAD2(ADD8(REG("sp"), 10))));
	// if (w8 s>= 0xa) then 4 else 6
	if(CMP_SGE4(REG("w8"), 10))
		goto loc_4;
	else
	...
	loc_8:
	// if (w8 & 0x1 != 0) then 9 @ 0x35c else 12 @ 0x350
	if(CMP_NE(AND(REG("w8"), 1), 0))
		goto loc_9;
	else
		goto loc_12;
...
void test_word_ult_10(void)
{
	...
	loc_8:
	// if (w8 & 0x1 != 0) then 9 @ 0x394 else 12 @ 0x388
	if(CMP_NE(AND(REG("w8"), 1), 0))
		goto loc_9;
	else
		goto loc_12;
...
void test_word_sle_10(void)
{
	...
	loc_8:
	// if (w8 & 0x1 != 0) then 9 @ 0x3cc else 12 @ 0x3c0
	if(CMP_NE(AND(REG("w8"), 1), 0))
		goto loc_9;
	else
		goto loc_12;
...
void test_word_ule_10(void)
{
	...
	loc_8:
	// if (w8 & 0x1 != 0) then 9 @ 0x404 else 12 @ 0x3f8
	if(CMP_NE(AND(REG("w8"), 1), 0))
		goto loc_9;
	else
		goto loc_12;
...
void test_word_sge_10(void)
{
	...
	loc_8:
	// if (w8 & 0x1 != 0) then 9 @ 0x43c else 12 @ 0x430
	if(CMP_NE(AND(REG("w8"), 1), 0))
		goto loc_9;
	else
		goto loc_12;
...
void test_word_uge_10(void)
{
	...
	loc_8:
	// if (w8 & 0x1 != 0) then 9 @ 0x474 else 12 @ 0x468
	if(CMP_NE(AND(REG("w8"), 1), 0))
		goto loc_9;
	else
		goto loc_12;
...
void test_word_sgt_10(void)
{
	...
	loc_8:
	// if (w8 & 0x1 != 0) then 9 @ 0x4ac else 12 @ 0x4a0
	if(CMP_NE(AND(REG("w8"), 1), 0))
		goto loc_9;
	else
		goto loc_12;
...
void test_word_ugt_10(void)
{
	...
	loc_8:
	// if (w8 & 0x1 != 0) then 9 @ 0x4e4 else 12 @ 0x4d8
	if(CMP_NE(AND(REG("w8"), 1), 0))
		goto loc_9;
	else
		goto loc_12;
...
void test_word_neg(void)
{
	...
	loc_8:
	// if (w8 & 0x1 != 0) then 9 @ 0x51c else 12 @ 0x510
	if(CMP_NE(AND(REG("w8"), 1), 0))
		goto loc_9;
	else
		goto loc_12;
...
void test_word_pos(void)
{
	...
	loc_8:
	// if (w8 & 0x1 != 0) then 9 @ 0x554 else 12 @ 0x548
	if(CMP_NE(AND(REG("w8"), 1), 0))
		goto loc_9;
	else
		goto loc_12;
...
void triangle_up(void)
{
	...
	STORE4(ADD8(REG("sp"), 12), REG("w0"));
	// [sp + 4 {var_c}].d = 0
	STORE4(ADD8(REG("sp"), 4), 0);
	// [sp + 8 {var_8}].d = w8
	STORE4(ADD8(REG("sp"), 8), REG("w8"));
	// goto 6 @ 0x57c
	goto loc_6;

	loc_6:
	// w8 = [sp + 8 {var_8}].d
	SET_REG4("w8", LOAD4(ADD8(REG("sp"), 8)));
	// w9 = [sp + 0xc {var_4}].d
	SET_REG4("w9", LOAD4(ADD8(REG("sp"), 12)));
	// if (w8 s> w9) then 9 else 11
	if(CMP_SGT4(REG("w8"), REG("w9")))
		goto loc_9;
	else
		goto loc_11;
	...
	loc_13:
	// if (w8 & 0x1 != 0) then 14 @ 0x5b0 else 17 @ 0x590
	if(CMP_NE(AND(REG("w8"), 1), 0))
		goto loc_14;
	else
		goto loc_17;
	...
	loc_14:
	// w0 = [sp + 4 {var_c}].d
	SET_REG4("w0", LOAD4(ADD8(REG("sp"), 4)));
	// sp = sp + 0x10
	SET_REG8("sp", ADD8(REG("sp"), 0x10));
	// <return> jump(x30)
	RET(REG("x30"));
	...
	SET_REG4("w8", LOAD4(ADD8(REG("sp"), 8)));
	// w9 = [sp + 4 {var_c}].d
	SET_REG4("w9", LOAD4(ADD8(REG("sp"), 4)));
	// w8 = w9 + w8
	SET_REG4("w8", ADD4(REG("w9"), REG("w8")));
	// [sp + 4 {var_c}].d = w8
	STORE4(ADD8(REG("sp"), 4), REG("w8"));
	// w8 = [sp + 8 {var_8}].d
	SET_REG4("w8", LOAD4(ADD8(REG("sp"), 8)));
	// w8 = w8 + 1
	SET_REG4("w8", ADD4(REG("w8"), 1));
	// [sp + 8 {var_8}].d = w8
	STORE4(ADD8(REG("sp"), 8), REG("w8"));
	// goto 6 @ 0x57c
	goto loc_6;
...
void triangle_down(void)
{
	...
	loc_12:
	// if (w8 & 0x1 != 0) then 13 @ 0x604 else 16 @ 0x5e0
	if(CMP_NE(AND(REG("w8"), 1), 0))
		goto loc_13;
	else
		goto loc_16;
	...
	SET_REG4("w9", -1);
	// w8 = w8 + w9
	SET_REG4("w8", ADD4(REG("w8"), REG("w9")));
	// [sp + 8 {var_8}].d = w8
	STORE4(ADD8(REG("sp"), 8), REG("w8"));
	// goto 6 @ 0x5d0
	goto loc_6;
...
void multiply_u8(void)
{
	...
	SET_REG8("sp", SUB8(REG("sp"), 0x10));
	// [sp + 0xf {var_1}].b = w0.b
	STORE1(ADD8(REG("sp"), 15), LOW_PART1(REG("w0")));
	// [sp + 0xe {var_2}].b = w1.b
	STORE1(ADD8(REG("sp"), 14), LOW_PART1(REG("w1")));
	// w8 = zx.d([sp + 0xf {var_1}].b)
	SET_REG4("w8", ZX4(LOAD1(ADD8(REG("sp"), 15))));
	// w9 = zx.d([sp + 0xe {var_2}].b)
	SET_REG4("w9", ZX4(LOAD1(ADD8(REG("sp"), 14))));
	// w8 = w8 * w9
	SET_REG4("w8", MUL(REG("w8"), REG("w9")));
	// w0 = w8
	SET_REG4("w0", REG("w8"));
	// sp = sp + 0x10
	SET_REG8("sp", ADD8(REG("sp"), 0x10));
...
void multiply_loop(void)
{
	loc_0:
	// sp = sp - 0x20
	SET_REG8("sp", SUB8(REG("sp"), 0x20));
	// w8 = 1
	SET_REG4("w8", 1);
	// [sp + 0x1c {var_4}].d = w0
	STORE4(ADD8(REG("sp"), 0x1C), REG("w0"));
	// [sp + 0x18 {var_8}].d = w1
	STORE4(ADD8(REG("sp"), 0x18), REG("w1"));
	// [sp + 0x10 {var_10}].d = 0
	STORE4(ADD8(REG("sp"), 0x10), 0);
	// [sp + 0xc {var_14}].d = w8
	STORE4(ADD8(REG("sp"), 12), REG("w8"));
	// w8 = [sp + 0x18 {var_8}].d
	SET_REG4("w8", LOAD4(ADD8(REG("sp"), 0x18)));
	// if (w8 s>= 0) then 8 else 10
	if(CMP_SGE4(REG("w8"), 0))
		goto loc_8;
	else
	...
	loc_12:
	// if (w8 & 0x1 != 0) then 13 @ 0x698 else 15 @ 0x67c
	if(CMP_NE(AND(REG("w8"), 1), 0))
		goto loc_13;
	else
		goto loc_15;
	...
	SET_REG4("w9", 0);
	// w8 = w9 - w8
	SET_REG4("w8", SUB4(REG("w9"), REG("w8")));
	// [sp + 0x18 {var_8}].d = w8
	STORE4(ADD8(REG("sp"), 0x18), REG("w8"));
	// w8 = [sp + 0xc {var_14}].d
	SET_REG4("w8", LOAD4(ADD8(REG("sp"), 12)));
	// w8 = w9 - w8
	SET_REG4("w8", SUB4(REG("w9"), REG("w8")));
	...
	loc_23:
	// w8 = [sp + 0x14 {var_c}].d
	SET_REG4("w8", LOAD4(ADD8(REG("sp"), 0x14)));
	// w9 = [sp + 0x18 {var_8}].d
	SET_REG4("w9", LOAD4(ADD8(REG("sp"), 0x18)));
	// if (w8 s>= w9) then 26 else 28
	if(CMP_SGE4(REG("w8"), REG("w9")))
		goto loc_26;
	else
		goto loc_28;
	...
	loc_30:
	// if (w8 & 0x1 != 0) then 31 @ 0x6d0 else 36 @ 0x6b0
	if(CMP_NE(AND(REG("w8"), 1), 0))
		goto loc_31;
	else
		goto loc_36;
	...
	SET_REG4("w8", LOAD4(ADD8(REG("sp"), 12)));
	// w9 = [sp + 0x10 {var_10}].d
	SET_REG4("w9", LOAD4(ADD8(REG("sp"), 0x10)));
	// w0 = w8 * w9
	SET_REG4("w0", MUL(REG("w8"), REG("w9")));
	// sp = sp + 0x20
	SET_REG8("sp", ADD8(REG("sp"), 0x20));
	// <return> jump(x30)
	RET(REG("x30"));
	return;
	...
	loc_36:
	// w8 = [sp + 0x10 {var_10}].d
	SET_REG4("w8", LOAD4(ADD8(REG("sp"), 0x10)));
	// w9 = [sp + 0x1c {var_4}].d
	SET_REG4("w9", LOAD4(ADD8(REG("sp"), 0x1C)));
	// w8 = w8 + w9
	SET_REG4("w8", ADD4(REG("w8"), REG("w9")));
	// [sp + 0x10 {var_10}].d = w8
	STORE4(ADD8(REG("sp"), 0x10), REG("w8"));
	// w8 = [sp + 0x14 {var_c}].d
	SET_REG4("w8", LOAD4(ADD8(REG("sp"), 0x14)));
	// w8 = w8 + 1
	SET_REG4("w8", ADD4(REG("w8"), 1));
	// [sp + 0x14 {var_c}].d = w8
	STORE4(ADD8(REG("sp"), 0x14), REG("w8"));
	// goto 23 @ 0x69c
	goto loc_23;
}
...
void div(void)
{
	...
	SET_REG4("w9", LOAD4(ADD8(REG("sp"), 8)));
	// w0 = divs.d(w8, w9)
	SET_REG4("w0", DIVS(REG("w8"), REG("w9")));
	// sp = sp + 0x10
	SET_REG8("sp", ADD8(REG("sp"), 0x10));
	// <return> jump(x30)
	RET(REG("x30"));
...
void mod(void)
{
	...
	SET_REG4("w9", LOAD4(ADD8(REG("sp"), 8)));
	// w10 = divs.d(w8, w9)
	SET_REG4("w10", DIVS(REG("w8"), REG("w9")));
	// w9 = w10 * w9
	SET_REG4("w9", MUL(REG("w10"), REG("w9")));
	// w0 = w8 - w9
	SET_REG4("w0", SUB4(REG("w8"), REG("w9")));
	// sp = sp + 0x10
	SET_REG8("sp", ADD8(REG("sp"), 0x10));
	// <return> jump(x30)
	RET(REG("x30"));
...
void exp_dummy(void)
{
	...
	SET_REG4("w8", 1);
	// [sp + 0x18 {var_8}].d = w0
	STORE4(ADD8(REG("sp"), 0x18), REG("w0"));
	// [sp + 0x14 {var_c}].d = w1
	STORE4(ADD8(REG("sp"), 0x14), REG("w1"));
	// [sp + 0xc {var_14}].d = w8
	STORE4(ADD8(REG("sp"), 12), REG("w8"));
	// w8 = [sp + 0x18 {var_8}].d
	SET_REG4("w8", LOAD4(ADD8(REG("sp"), 0x18)));
	...
	SET_REG4("w8", LOAD4(ADD8(REG("sp"), 0x10)));
	// w9 = [sp + 0x14 {var_c}].d
	SET_REG4("w9", LOAD4(ADD8(REG("sp"), 0x14)));
	...
	loc_14:
	// w0 = [sp + 0x1c {var_4}].d
	SET_REG4("w0", LOAD4(ADD8(REG("sp"), 0x1C)));
	// sp = sp + 0x20
	SET_REG8("sp", ADD8(REG("sp"), 0x20));
	// <return> jump(x30)
	RET(REG("x30"));
	...
	loc_21:
	// if (w8 & 0x1 != 0) then 22 @ 0x788 else 25 @ 0x768
	if(CMP_NE(AND(REG("w8"), 1), 0))
		goto loc_22;
	else
		goto loc_25;
	...
	SET_REG4("w8", LOAD4(ADD8(REG("sp"), 12)));
	// [sp + 0x1c {var_4}].d = w8
	STORE4(ADD8(REG("sp"), 0x1C), REG("w8"));
	// goto 14 @ 0x790
	goto loc_14;
...
void expmod(void)
{
	...
	STORE4(ADD8(REG("sp"), 0x14), REG("w1"));
	// [sp + 0x10 {var_10}].d = w2
	STORE4(ADD8(REG("sp"), 0x10), REG("w2"));
	// [sp + 0xc {var_14}].d = w8
	STORE4(ADD8(REG("sp"), 12), REG("w8"));
	// w8 = [sp + 0x18 {var_8}].d
	SET_REG4("w8", LOAD4(ADD8(REG("sp"), 0x18)));
	...
	SET_REG4("w9", MUL(REG("w10"), REG("w9")));
	// w8 = w8 - w9
	SET_REG4("w8", SUB4(REG("w8"), REG("w9")));
	// [sp + 8 {var_18}].d = w8
	STORE4(ADD8(REG("sp"), 8), REG("w8"));
	// w8 = [sp + 0x14 {var_c}].d
	SET_REG4("w8", LOAD4(ADD8(REG("sp"), 0x14)));
	// w8 = w8 s>> 1
	SET_REG4("w8", ASR(REG("w8"), 1));
	// [sp + 0x14 {var_c}].d = w8
	STORE4(ADD8(REG("sp"), 0x14), REG("w8"));
	// goto 10 @ 0x7cc
	goto loc_10;
...
void gcd(void)
{
	...
	loc_24:
	// if (w8 & 0x1 != 0) then 25 @ 0x8ac else 32 @ 0x890
	if(CMP_NE(AND(REG("w8"), 1), 0))
		goto loc_25;
	else
		goto loc_32;
...
void gcd_recursive(void)
{
	...
	STORE8(ADD8(REG("sp"), 0x10), REG("x29"));
	// [sp + 0x18 {__saved_x30}].q = x30
	STORE8(ADD8(REG("sp"), 0x18), REG("x30"));
	// x29 = sp + 0x10 {__saved_x29}
	SET_REG8("x29", ADD8(REG("sp"), 0x10));
	// [sp + 8 {var_18}].d = w0
	STORE4(ADD8(REG("sp"), 8), REG("w0"));
	// [sp + 4 {var_1c}].d = w1
	STORE4(ADD8(REG("sp"), 4), REG("w1"));
	// w8 = [sp + 8 {var_18}].d
	SET_REG4("w8", LOAD4(ADD8(REG("sp"), 8)));
	...
	loc_8:
	// w8 = [sp + 4 {var_1c}].d
	SET_REG4("w8", LOAD4(ADD8(REG("sp"), 4)));
	...
	loc_19:
	// w0 = [x29 - 4 {var_14}].d
	SET_REG4("w0", LOAD4(ADD8(REG("x29"), -4)));
	// x29 = [sp + 0x10 {__saved_x29}].q
	SET_REG8("x29", LOAD8(ADD8(REG("sp"), 0x10)));
	// x30 = [sp + 0x18 {__saved_x30}].q
	SET_REG8("x30", LOAD8(ADD8(REG("sp"), 0x18)));
	// sp = sp + 0x20
	SET_REG8("sp", ADD8(REG("sp"), 0x20));
	// <return> jump(x30)
	RET(REG("x30"));
	...
	loc_28:
	// if (w8 & 0x1 != 0) then 29 @ 0x930 else 32 @ 0x924
	if(CMP_NE(AND(REG("w8"), 1), 0))
		goto loc_29;
	else
		goto loc_32;
	...
	loc_39:
	// if (w8 & 0x1 != 0) then 40 @ 0x960 else 47 @ 0x944
	if(CMP_NE(AND(REG("w8"), 1), 0))
		goto loc_40;
	else
		goto loc_47;
	...
	loc_40:
	// w0 = [sp + 8 {var_18}].d
	SET_REG4("w0", LOAD4(ADD8(REG("sp"), 8)));
	// w8 = [sp + 4 {var_1c}].d
	SET_REG4("w8", LOAD4(ADD8(REG("sp"), 4)));
	// w9 = [sp + 8 {var_18}].d
	SET_REG4("w9", LOAD4(ADD8(REG("sp"), 8)));
	// w1 = w8 - w9
	SET_REG4("w1", SUB4(REG("w8"), REG("w9")));
	// call(0x8d4)
	CALL(0x8D4, gcd_recursive, "gcd_recursive");
	// [x29 - 4 {var_14}].d = w0
	STORE4(ADD8(REG("x29"), -4), REG("w0"));
	// goto 19 @ 0x978
	goto loc_19;
	...
	SET_REG4("w0", SUB4(REG("w8"), REG("w9")));
	// w1 = [sp + 4 {var_1c}].d
	SET_REG4("w1", LOAD4(ADD8(REG("sp"), 4)));
	// call(0x8d4)
	CALL(0x8D4, gcd_recursive, "gcd_recursive");
	// [x29 - 4 {var_14}].d = w0
	STORE4(ADD8(REG("x29"), -4), REG("w0"));
...
void switch_doubler(void)
{
	...
	SET_REG4("w9", REG("w8"));
	// x9 = x9.d
	SET_REG8("x9", LOW_PART4(REG("x9")));
	// if (x9 u> 0xa) then 7 else 9
	if(CMP_UGT(REG("x9"), 10))
		goto loc_7;
	else
		goto loc_9;
	...
	loc_11:
	// [sp {var_10}].q = x9
	STORE8(REG("sp"), REG("x9"));
	// if (w8 & 0x1 != 0) then 13 @ 0xa48 else 18 @ 0x9b0
	if(CMP_NE(AND(REG("w8"), 1), 0))
		goto loc_13;
	else
		goto loc_18;
	...
	SET_REG8("x8", 0x0);
	// x8 = x8 + 0xb40
	SET_REG8("x8", ADD8(REG("x8"), 0xB40));
	// x11 = [sp {var_10}].q
	SET_REG8("x11", LOAD8(REG("sp")));
	// x10 = sx.q([x8 + (x11 << 2)].d)
	SET_REG8("x10", SX4(LOAD4(ADD8(REG("x8"), LSL(REG("x11"), 2)))));
	// x9 = x8 + x10
	SET_REG8("x9", ADD8(REG("x8"), REG("x10")));
	// jump(x9)
	JUMP(REG("x9"));
}
...
void factorial(void)
{
	...
	loc_11:
	// if (w8 & 0x1 != 0) then 12 @ 0xa88 else 21 @ 0xa7c
	if(CMP_NE(AND(REG("w8"), 1), 0))
		goto loc_12;
	else
		goto loc_21;
	...
	SET_REG4("w8", LOAD4(ADD8(REG("sp"), 4)));
	// w9 = w8 * w0
	SET_REG4("w9", MUL(REG("w8"), REG("w0")));
	// [x29 - 4 {var_14}].d = w9
	STORE4(ADD8(REG("x29"), -4), REG("w9"));
	// goto 24 @ 0xaa8
	goto loc_24;
...
void fp_single_add(void)
{
	...
	SET_REG8("sp", SUB8(REG("sp"), 0x10));
	// [sp + 0xc {var_4}].d = s0
	STORE4(ADD8(REG("sp"), 12), REG("s0"));
	// [sp + 8 {var_8}].d = s1
	STORE4(ADD8(REG("sp"), 8), REG("s1"));
	// s0 = [sp + 0xc {var_4}].d
	SET_REG4("s0", LOAD4(ADD8(REG("sp"), 12)));
	// s1 = [sp + 8 {var_8}].d
	SET_REG4("s1", LOAD4(ADD8(REG("sp"), 8)));
	// s0 = s0 f+ s1
	SET_REG4("s0", FADD(REG("s0"), REG("s1")));
	// sp = sp + 0x10
	SET_REG8("sp", ADD8(REG("sp"), 0x10));
	// <return> jump(x30)
	RET(REG("x30"));
...
void fp_single_sub(void)
{
	...
	SET_REG4("s1", LOAD4(ADD8(REG("sp"), 8)));
	// s0 = s0 f- s1
	SET_REG4("s0", FSUB(REG("s0"), REG("s1")));
	// sp = sp + 0x10
	SET_REG8("sp", ADD8(REG("sp"), 0x10));
	// <return> jump(x30)
	RET(REG("x30"));
...
void fp_single_mul(void)
{
	...
	SET_REG4("s1", LOAD4(ADD8(REG("sp"), 8)));
	// s0 = s0 f* s1
	SET_REG4("s0", FMUL(REG("s0"), REG("s1")));
	// sp = sp + 0x10
	SET_REG8("sp", ADD8(REG("sp"), 0x10));
	// <return> jump(x30)
	RET(REG("x30"));
...
void fp_single_div(void)
{
	...
	SET_REG4("s1", LOAD4(ADD8(REG("sp"), 8)));
	// s0 = s0 f/ s1
	SET_REG4("s0", FDIV(REG("s0"), REG("s1")));
	// sp = sp + 0x10
	SET_REG8("sp", ADD8(REG("sp"), 0x10));
	// <return> jump(x30)
	RET(REG("x30"));
...
map<string,struct RegisterInfo> regInfos = {
	...
	{"syscall_imm", {65302, "syscall_imm", 0, 2, 0}}, /* <reg: size 2, offset 0 in syscall_imm> */
};

string stackRegName = "sp";
bool isLinkRegArch = true;
string linkRegName = "x30";
