/* binary method1: cs_disasm_iter()
	g++ method1.cpp -o method1 -lcapstone
*/
...
int main(int ac, char **av)
{
	...
	for(int i=0; i<NUM_TESTS; ++i) {
		...
		addr = 0;
		const uint8_t *pinsword = (uint8_t *)&insword;
		size = 4;
		count = cs_disasm_iter(handle, &pinsword, &size, &addr, insn);
